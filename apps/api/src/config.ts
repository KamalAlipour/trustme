...
export const apiConfigSchema = z.object({
  ...
  onramperApiKey: z.string().optional(),
  onramperSigningKeyPem: z.string().optional(),
...
export function loadApiConfig(env: NodeJS.ProcessEnv = process.env): ApiConfig {
  const config = apiConfigSchema.parse({
    ...
    onramperApiKey: env.ONRAMPER_API_KEY || undefined,
    onramperSigningKeyPem: env.ONRAMPER_SIGNING_KEY_PEM?.replace(/\\n/g, '\n') || undefined,
