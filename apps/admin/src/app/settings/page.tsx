...
type Settings = { withdrawalBaseFeeBps: string; minimumFeeMicroUsdt: string; minimumWithdrawalMicroUsdt: string; autoApprovalLimitMicroUsdt: string; requireIdentityForWithdrawal: boolean; custodialReservesEnabled: boolean; transakEnabled: boolean; identityRequiredCountries: string[]; commissionFloorBps: number; commissionFloorByCountry: Array<{ country: string; bps: number }>; trainerCutBps: number; displayUnit: { en: { singular: string; plural: string }; fa: string } };
