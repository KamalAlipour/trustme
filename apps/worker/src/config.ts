...
export const workerConfigSchema = z.object({
  ...
  escrowContractAddress: z.string().regex(/^0x[0-9a-fA-F]{40}$/).optional(),
  escrowSettlerKey: optionalString,
  ...
  twilioAccountSid: optionalString,
  twilioAuthToken: optionalString,
  twilioFrom: optionalString,
...
export function loadWorkerConfig(env: NodeJS.ProcessEnv = process.env): WorkerConfig {
  return workerConfigSchema.parse({
    ...
    escrowSettlerKey: env.ESCROW_SETTLER_KEY,
