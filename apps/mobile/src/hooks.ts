...
import type { AidRequest, Balance, BalanceDisclosure, Charity, CharityGuarantee, Contact, EscrowBalance, EscrowConfig, EscrowSettlement, EscrowUnload, IdentityInfo, Loan, Member, RefundRequest, TransactionsPage, WithdrawalAvailability } from './api/types';
...
export function useInvalidateMoney() {
  ...
  return () => Promise.all([client.invalidateQueries({ queryKey: ['me'] }), client.invalidateQueries({ queryKey: ['identity'] }), client.invalidateQueries({ queryKey: ['disclosures'] }), client.invalidateQueries({ queryKey: ['balance'] }), client.invalidateQueries({ queryKey: ['withdrawal-availability'] }), client.invalidateQueries({ queryKey: ['transactions'] }), client.invalidateQueries({ queryKey: ['loans'] }), client.invalidateQueries({ queryKey: ['refunds'] }), client.invalidateQueries({ queryKey: ['aid-requests'] }), client.invalidateQueries({ queryKey: ['charity-requests'] }), client.invalidateQueries({ queryKey: ['charity-guarantees'] }), client.invalidateQueries({ queryKey: ['escrow-balance'] }), client.invalidateQueries({ queryKey: ['escrow-settlements'] }), client.invalidateQueries({ queryKey: ['escrow-unloads'] })]);
}
