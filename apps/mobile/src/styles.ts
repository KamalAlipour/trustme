...
export const styles = StyleSheet.create({
  ...
  title: { color: colors.ink, fontSize: 26, fontWeight: '700', textAlign: 'auto' },
  heading: { color: colors.ink, fontSize: 20, fontWeight: '700', textAlign: 'auto' },
  text: { color: colors.ink, fontSize: 16, textAlign: 'auto', lineHeight: 25 },
  muted: { color: colors.muted, fontSize: 14, textAlign: 'auto', lineHeight: 22 },
  card: { backgroundColor: colors.card, borderRadius: 18, padding: 18, gap: 10, borderWidth: 1, borderColor: colors.border },
  input: { backgroundColor: colors.card, borderWidth: 1, borderColor: colors.border, borderRadius: 12, padding: 13, fontSize: 16, color: colors.ink, textAlign: 'auto' },
  ...
  danger: { color: colors.danger, fontSize: 14, textAlign: 'auto' },
  notice: { color: colors.success, fontSize: 14, textAlign: 'auto' },
