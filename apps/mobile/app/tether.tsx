...
export default function Tether() {
  ...
  return (
    <Page>
      ...
      {message && draftWords === null ? <Text style={styles.danger}>{message}</Text> : null}
    </Page>
  );
}
